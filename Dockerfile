...
RUN rm -rf ./internal/model/do ./internal/model/entity ./internal/dao
RUN rm -rf ./internal/service

RUN wget -O gf "https://github.com/gogf/gf/releases/download/v2.5.2/gf_$(go env GOOS)_$(go env GOARCH)" && chmod +x gf && ./gf install -y && rm ./gf
